...
#comparing number of columns in 3 datasets and a number of columns in 
combine_candy dataset
...
```
```{r}
#Top 3 most popular candies per gender 
...
```
```{r}
#Top 3 most popular candies per year
...
```{r}
#Top 3 most popular candies per country
...
ggplot(candy_analysis_missing_year, aes(fill=rating, x=Year, y=n)) + 
    geom_bar(position="fill", stat="identity") +
labs(title = "Proportion of ratings (per year) ", x = "year", y = "proportion",
     subtitle = "False = Present Data, True = Missing Data", fill= "missing or not")
...
ggplot(candy_analysis_missing_gender, aes(fill=rating, x=gender, y=n)) + 
    geom_bar(position="fill", stat="identity") +
labs(title = "Proportion of ratings (per gender) ", x = "gender",
     y = "proportion",
     subtitle = "False = Present Data, True = Missing Data", fill= "missing or not")
...
ggplot(candy_analysis_missing_country, aes(fill=rating, x=country, y=n)) + 
    geom_bar(position="fill", stat="identity") +
labs(title = "Proportion of ratings (per country) ", x = "country",
     y = "proportion",
     subtitle = "False = Present Data, True = Missing Data", fill= "missing or not") + scale_y_continuous(label = label_percent())
```
